    ...
    <div id="Contact" className="mt-5">
      ...
      {/* <div className="d-inline-flex mt-5 mb-5">
        <div id="contactSite" className="ms-4 me-4 rounded w-100">
          <span className="material-icons-outlined contactIcon rounded-circle">home</span>
        ...
        <div id="contactSite" className="ms-4 me-4 rounded w-100">
          <span className="material-icons-outlined contactIcon rounded-circle">phone</span>
        ...
        <div id="contactSite" className="ms-4 me-4 rounded w-100">
          <span className="material-icons-outlined contactIcon rounded-circle">email</span>
        ...
        <div id="contactSite" className="ms-4 me-4 rounded w-100">
          <span className="material-icons-outlined contactIcon rounded-circle">facebook</span>
